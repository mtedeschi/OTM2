...
from treemap.views import (boundary_to_geojson_view, index_view, map_view,
                           ...
                           delete_map_feature_view, get_plot_detail_view,
...
urlpatterns = patterns(
    ...
    url(r'^features/(?P<type>\w+)/(?P<feature_id>\d+)/$',
        route(PUT=update_map_feature_detail_view,
    ...
    url(r'^plots/(?P<feature_id>\d+)/$',
        route(GET=get_plot_detail_view, PUT=update_map_feature_detail_view,
              DELETE=delete_map_feature_view),
        name='plot_detail'),
    url(r'^plots/(?P<feature_id>\d+)/$',
        get_plot_detail_view, name='plot_detail'),
    url(r'^plots/(?P<feature_id>\d+)/sidebar$',
        get_plot_sidebar_view, name='plot_sidebar'),
    ...
    url(r'^plots/(?P<feature_id>\d+)/(?P<edit>edit)$',
        edit_plot_detail_view, name='plot_detail_edit'),
    url(r'^plots/(?P<feature_id>\d+)/trees/(?P<tree_id>\d+)/$',
        route(GET=get_plot_detail_view, DELETE=delete_tree_view,
